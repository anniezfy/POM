module {
  func @"2mm"(%arg0: f32, %arg1: f32, %arg2: f32, %arg3: memref<4096x4096xf32, affine_map<(d0, d1) -> (d0 mod 16, d1 mod 4, d0 floordiv 16, d1 floordiv 4)>>, %arg4: memref<4096x4096xf32, affine_map<(d0, d1) -> (d0 mod 4, d1 mod 2, d0 floordiv 4, d1 floordiv 2)>>, %arg5: memref<4096x4096xf32, affine_map<(d0, d1) -> (0, 0, d0, d1)>>, %arg6: memref<4096x4096xf32, affine_map<(d0, d1) -> (0, 0, d0, d1)>>, %arg7: memref<4096x4096xf32, affine_map<(d0, d1) -> (d0 mod 16, d1 mod 2, d0 floordiv 16, d1 floordiv 2)>>) attributes {resource = #hls.r<lut=0, dsp=208, bram=0>, timing = #hls.t<0 -> 826949001262, 826949001262, 826949001262>, top_func} {
    ...
    affine.for %arg8 = 0 to 4096 {
      affine.for %arg9 = 0 to 4096 {
        affine.for %arg10 = 0 to 4096 {
          %0 = affine.load %arg7[%arg10, %arg8] {max_mux_size = 16 : i64, partition_indices = [-1, -1], timing = #hls.t<0 -> 2, 2, 1>} : memref<4096x4096xf32, affine_map<(d0, d1) -> (d0 mod 16, d1 mod 2, d0 floordiv 16, d1 floordiv 2)>>
          %1 = affine.load %arg5[%arg8, %arg9] {partition_indices = [0, 0], timing = #hls.t<0 -> 2, 2, 1>} : memref<4096x4096xf32, affine_map<(d0, d1) -> (0, 0, d0, d1)>>
          %2 = arith.mulf %0, %1 {timing = #hls.t<2 -> 6, 4, 1>} : f32
          %3 = affine.load %arg6[%arg10, %arg9] {partition_indices = [0, 0], timing = #hls.t<4 -> 6, 2, 1>} : memref<4096x4096xf32, affine_map<(d0, d1) -> (0, 0, d0, d1)>>
          %4 = arith.addf %2, %3 {timing = #hls.t<6 -> 11, 5, 1>} : f32
          affine.store %4, %arg6[%arg10, %arg9] {partition_indices = [0, 0], timing = #hls.t<11 -> 12, 1, 1>} : memref<4096x4096xf32, affine_map<(d0, d1) -> (0, 0, d0, d1)>>
        } {loop_info = #hls.l<flattenTripCount=4096, iterLatency=12, minII=12>, parallel, timing = #hls.t<0 -> 49154, 49154, 49154>}
    ...
    } {loop_info = #hls.l<flattenTripCount=4096, iterLatency=201334786, minII=201334786>, timing = #hls.t<2281717802 -> 826949001260, 824667283458, 824667283458>}
