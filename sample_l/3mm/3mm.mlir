module {
  func @"3mm"(%arg0: f32, %arg1: memref<4096x4096xf32, affine_map<(d0, d1) -> (0, 0, d0, d1)>>, %arg2: memref<4096x4096xf32, affine_map<(d0, d1) -> (0, d1 mod 16, d0, d1 floordiv 16)>>, %arg3: memref<4096x4096xf32, affine_map<(d0, d1) -> (0, 0, d0, d1)>>, %arg4: memref<4096x4096xf32, affine_map<(d0, d1) -> (0, d1 mod 16, d0, d1 floordiv 16)>>, %arg5: memref<4096x4096xf32, affine_map<(d0, d1) -> (d0 mod 2, d1 mod 16, d0 floordiv 2, d1 floordiv 16)>>, %arg6: memref<4096x4096xf32, affine_map<(d0, d1) -> (0, d1 mod 16, d0, d1 floordiv 16)>>, %arg7: memref<4096x4096xf32, affine_map<(d0, d1) -> (0, d1 mod 16, d0, d1 floordiv 16)>>) attributes {resource = #hls.r<lut=0, dsp=80, bram=0>, timing = #hls.t<0 -> 12918980655, 12918980655, 12918980655>, top_func} {
