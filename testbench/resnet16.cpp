...
int main(){
    ...
    // ReLU = max()
    compute s_3("s_3",{o,y,x},fo1(o,y,x),fo1(o,y,x));
    s_2.after(s_1,-1);
    s_3.after(s_2,-1);
    ...
    // ReLU = max()
    compute s_6("s_6",{o,y,x},fo2(o,y,x),fo2(o,y,x));
    s_4.after(s_3,-1);
    s_5.after(s_4,-1);
    s_6.after(s_5,-1);
    ...
    // ReLU = max()
    compute s_10("s_10",{o,y,x},fo4(o,y,x),fo4(o,y,x));
    s_7.after(s_6,-1);
    s_8.after(s_7,-1);
    s_9.after(s_8,-1);
    s_10.after(s_9,-1);
    ...
    // ReLU = max()
    compute s_13("s_13",{o,y,x},fo5(o,y,x),fo5(o,y,x));   
    s_11.after(s_10,-1);
    s_12.after(s_11,-1);
    s_13.after(s_12,-1);
    ...
    // ReLU = max()
    compute s_17("s_17",{o,y,x},fo7(o,y,x),fo7(o,y,x));
    s_14.after(s_13,-1);
    s_15.after(s_14,-1);
    s_16.after(s_15,-1);
    s_17.after(s_16,-1);
    ...
    // ReLU = max()
    compute s_20("s_20",{o2,y2,x2},fo8(o2,y2,x2),fo8(o2,y2,x2));
    s_18.after(s_17,-1);
    s_19.after(s_18,-1);
    s_20.after(s_19,-1);
    ...
    // ReLU = max()
    compute s_25("s_25",{o2,y2,x2},fo11(o2,y2,x2),fo11(o2,y2,x2));
    s_21.after(s_20,-1);
    s_22.after(s_21,-1);
    s_23.after(s_22,-1);
    s_24.after(s_23,-1);
    ...
    // ReLU = max()
    compute s_28("s_28",{o2,y2,x2},fo12(o2,y2,x2),fo12(o2,y2,x2));
    ...
    // ReLU = max()
    compute s_32("s_32",{o2,y2,x2},fo14(o2,y2,x2),fo14(o2,y2,x2));
    s_26.after(s_25,-1);
    s_27.after(s_26,-1);
    s_28.after(s_27,-1);
    s_29.after(s_28,-1);
    ...
    // ReLU = max()
    compute s_35("s_35",{o3,y3,x3},fo15(o3,y3,x3),fo15(o3,y3,x3));
    s_33.after(s_32,-1);
    s_34.after(s_33,-1);
    s_35.after(s_34,-1);
    ...
    // ReLU = max()
    compute s_40("s_40",{o3,y3,x3},fo18(o3,y3,x3),fo18(o3,y3,x3));
    s_36.after(s_35,-1);
    s_37.after(s_36,-1);
    s_38.after(s_37,-1);
    s_39.after(s_38,-1);
    ...
    // ReLU = max()
    compute s_43("s_43",{o3,y3,x3},fo19(o3,y3,x3),fo19(o3,y3,x3));
    ...
    // ReLU = max()
    compute s_47("s_47",{o3,y3,x3},fo21(o3,y3,x3),fo21(o3,y3,x3));
    s_41.after(s_40,-1);
    s_42.after(s_41,-1);
    s_43.after(s_42,-1);
    s_44.after(s_43,-1);
    ...
    // ReLU = max()
    compute s_50("s_50",{o4,y4,x4},fo22(o4,y4,x4),fo22(o4,y4,x4));
    s_48.after(s_47,-1);
    s_49.after(s_48,-1);
    s_50.after(s_49,-1);
    ...
    // ReLU = max()
    compute s_55("s_55",{o4,y4,x4},fo25(o4,y4,x4),fo25(o4,y4,x4));
    s_51.after(s_50,-1);
    s_52.after(s_51,-1);
    s_53.after(s_52,-1);
    s_54.after(s_53,-1);
    ...
    // ReLU = max()
    compute s_58("s_58",{o4,y4,x4},fo26(o4,y4,x4),fo26(o4,y4,x4));
    ...
    // ReLU = max()
    compute s_62("s_62",{o4,y4,x4},fo28(o4,y4,x4),fo28(o4,y4,x4));
    s_56.after(s_55,-1);
    s_57.after(s_56,-1);
    s_58.after(s_57,-1);
    s_59.after(s_58,-1);
    ...
    fct->dump_schedule("/home/POM/samples/resnet/");
    ...
    // //ReLu = max()
    // compute s_11("s_11",{o2,y2,x2},fo4(o2,y2,x2),fo4(o2,y2,x2));
    // s_9.after(s_8,-1);
    // s_10.after(s_9,-1);
    // s_11.after(s_10,-1);
    ...
    // //ReLu = max()
    // compute s_14("s_14",{o2,y2,x2},fo5(o2,y2,x2),fo5(o2,y2,x2));
    // s_12.after(s_11,-1);
    // s_13.after(s_12,-1);
    // s_14.after(s_13,-1);
    ...
    // //ReLu = max()
    // compute s_19("s_19",{o3,y3,x3},fo7(o3,y3,x3),fo7(o3,y3,x3));
    // s_17.after(s_16,-1);
    // s_18.after(s_17,-1);
    // s_19.after(s_18,-1);
    ...
    // //ReLu = max()
    // compute s_22("s_22",{o3,y3,x3},fo8(o3,y3,x3),fo8(o3,y3,x3));
    ...
    // //ReLu = max()
    // compute s_25("s_25",{o3,y3,x3},fo9(o3,y3,x3),fo9(o3,y3,x3));
    // s_20.after(s_19,-1);
    // s_21.after(s_20,-1);
    // s_22.after(s_21,-1);
    // s_23.after(s_22,-1);
    ...
    // //ReLu = max()
    // compute s_30("s_30",{o4,y4,x4},fo11(o4,y4,x4),fo11(o4,y4,x4));
    // s_28.after(s_27,-1);
    // s_29.after(s_28,-1);
    // s_30.after(s_29,-1);
    ...
    // //ReLu = max()
    // compute s_33("s_33",{o4,y4,x4},fo12(o4,y4,x4),fo12(o4,y4,x4));
    ...
    // //ReLu = max()
    // compute s_36("s_36",{o4,y4,x4},fo13(o4,y4,x4),fo13(o4,y4,x4));
    // s_31.after(s_30,-1);
    // s_32.after(s_31,-1);
    // s_33.after(s_32,-1);
    // s_34.after(s_33,-1);
    ...
    // //ReLu = max()
    // compute s_41("s_41",{o5,y5,x5},fo15(o5,y5,x5),fo15(o5,y5,x5));
    // s_39.after(s_38,-1);
    // s_40.after(s_39,-1);
    // s_41.after(s_40,-1);
    ...
    // //ReLu = max()
    // compute s_44("s_44",{o5,y5,x5},fo16(o5,y5,x5),fo16(o5,y5,x5));
    ...
    // //ReLu = max()
    // compute s_47("s_47",{o5,y5,x5},fo17(o5,y5,x5),fo17(o5,y5,x5));
    // s_42.after(s_41,-1);
    // s_43.after(s_42,-1);
    // s_44.after(s_43,-1);
    // s_45.after(s_44,-1);
    ...
    //     }
    // }
    // fct->dump_schedule("/home/POM/samples/vgg16/");
